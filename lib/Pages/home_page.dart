          ...
          children: <Widget>[
            ...
            FanCarouselImageSlider(
              ...
              currentItemShadow: const [
                BoxShadow(
                    offset: Offset(1, 1), color: Colors.white, blurRadius: 10),
              ],
              sliderDuration: const Duration(milliseconds: 300),
              expandedCloseChild: const Padding(
                  padding: EdgeInsets.symmetric(horizontal: 45, vertical: 20),
                  child: Text("mohammad vanaki")),
            ),
                ...
                children: <Widget>[
                  ...
                  Positioned(
                    ...
                    child: Text(
                      ...
                      style: TextStyle(
                        color: Constants.textColor,fontFamily: 'Jazeera-Bold',
                        fontSize: 16,
                      ),
                    ),
                  )
